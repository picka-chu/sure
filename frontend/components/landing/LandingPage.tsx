      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-md shadow-sm border-b border-surface-100" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/developer" className="text-sm text-surface-600 hover:text-surface-900 transition-colors">Developer API</Link>
            </nav>
        ...
        {mobileMenu && (
          <div className="md:hidden bg-white border-t border-surface-100 px-4 py-4 space-y-3 animate-fade-in">
            ...
            <Link href="/developer" className="block w-full text-left px-3 py-2 text-sm text-surface-600 hover:bg-surface-50 rounded-lg">Developer API</Link>
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Link href="/developer" className="block text-sm text-surface-500 hover:text-surface-700 transition-colors">Developer API</Link>
